...
public class addbook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("ADD BOOK DETAILS");
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 470, -1, -1));
        ...
        jPanel3.add(emailid, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 390, 220, 40));
        ...
        jPanel3.add(user, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 130, 220, 40));
        ...
        jPanel3.add(ph, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 320, 220, 40));

        utype.setBackground(new java.awt.Color(51, 51, 51));
        utype.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "FICTION", "TRAGEDY", "ROMANCE", "THILLER", "CRIME FICTION", "FANTASY", "ADVENTURE", "FAIRYTALE", "MYSTERY", "HORROR", "EDUCATION", "SCIENCE", "BIOGRAPHY", "NOVELS", "MOTIVATION", "LIFE", " " }));
        utype.setToolTipText("");
        utype.setBorder(null);
        utype.setCursor(new java.awt.Cursor(java.awt.Cursor.MOVE_CURSOR));
        jPanel3.add(utype, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 260, 220, 30));

        cor.setBackground(new java.awt.Color(51, 51, 51));
        cor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "100", "101", "102", "103", "104", "105", "106", "107", "108", "109", "110", "111", "112", "113", "114", "115", "116", "117", "118", "119", "120", " " }));
        cor.setToolTipText("");
        cor.setBorder(null);
        jPanel3.add(cor, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 200, 90, 30));
        ...
        jPanel3.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 400, 180, 30));

        deg.setBackground(new java.awt.Color(51, 51, 51));
        deg.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1.NOVEL", "2.BIO", "3.ABIO", "4.TALE", "5.QUIZ", "1.ENGG", "2.DES", "3.MAT", "4.ENG", "5.SCI", "6.COMM", "7.SOCI", "1.ART", "2.MUSIC", "1.EXAM", "OTHERS", " " }));
        deg.setToolTipText("");
        deg.setBorder(null);
        jPanel3.add(deg, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 200, 90, 30));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "BOOK", "BOOKPRE", "BOOKID", "CATEGORY", "AUTHOR", "YEAR", "COUNT"
            }
        ));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 180, 640, 560));

        fetch.setBackground(new java.awt.Color(153, 255, 255));
        fetch.setFont(new java.awt.Font("Georgia", 1, 18)); // NOI18N
        fetch.setForeground(new java.awt.Color(0, 0, 0));
        fetch.setText("FETCH");
        fetch.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                fetchMouseClicked(evt);
            }
        });
        jPanel1.add(fetch, new org.netbeans.lib.awtextra.AbsoluteConstraints(1370, 140, -1, -1));
...
stu.setVisible(true);        // TODO add your handling code here:
  ...
  add.setVisible(true);          // TODO add your handling code here:
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(reader.isEmpty() || type.isEmpty() || phone.isEmpty() || email.isEmpty() || degree.isEmpty() || course.isEmpty())
        {
            JOptionPane.showMessageDialog(this,"FILL IN EMPTY FIELDS !","WARNING",JOptionPane.ERROR_MESSAGE);
        }

        else{
            // SQL query for insertion
            String insertQuery = "INSERT INTO book (bname,bookpre,bookid,categ,author,year) VALUES (?,?,?,?,?,?)";
    ...
    private void fetchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_fetchMouseClicked
